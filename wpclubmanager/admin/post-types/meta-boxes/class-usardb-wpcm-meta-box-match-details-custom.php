...
class USARDB_WPCM_Meta_Box_Match_Details_Custom {
     ...
     * Primary constructor.
     *
     * @global USARDB_WPCM_Timezone_Picker $timezone_picker Timezone picker instance.
     *
    ...
    public function __construct() {
        ...
        add_action( 'usardb_wpcm_wp_text_input_wpcm_match_date', array( $this, 'website_kickoff_time' ), 10, 1 );
        add_action( 'usardb_wpcm_wp_text_input_wpcm_match_date', array( $this, 'website_timezone_abbr' ), 11, 1 );
        add_action( 'usardb_wpcm_wp_text_input_usar_match_date_local', array( $this, 'local_kickoff_time' ), 10, 1 );
        add_action( 'usardb_wpcm_wp_text_input_usar_match_date_local', array( $this, 'local_timezone_abbr' ), 11, 1 );
    ...
    public function website_kickoff_time( $post ) {
        ...
        return usardb_wpcm_wp_text_input(
            array(
