...
( function( factory ) {
    ...
    var methods = {
        ...
        show: function( e ) {
            ...
            if ( settings.stopScrollPropagation ) {
                $doc.on( 'wheel.ui-timepicker', '.ui-timepicker-wrapper', function( e ) {
                    e.preventDefault();
            ...
            $win.on( 'resize.ui-timepicker', _closeHandler );
            if ( settings.closeOnWindowScroll ) {
                $doc.on( 'scroll.ui-timepicker', _closeHandler );
            }
    ...
    function _closeHandler( e ) {
        ...
        methods.hide();
        $doc.unbind( '.ui-timepicker' );
        $win.unbind( '.ui-timepicker' );
    }
    ...
    $.fn.jquery_timepicker = function( method ) {
        ...
        if ( methods[ method ] ) {
            ...
            $.error( 'Method ' + method + ' does not exist on $.fn.jquery_timepicker' );
        }
    };
