...
class USARDB_WPCM_Timezone_Picker {

    /**
     * Class instance.
     *
     * @var USARDB_WPCM_Timezone_Picker
     */
     ...
     * Initialize class.
     *
     * @return USARDB_WPCM_Timezone_Picker
     */
    ...
    /**
     * Render timezone dropdown via {@see 'usardb_wpcm_wp_text_input'}.
     *
     * @since 1.0.0
     *
     * @see usardb_wpcm_wp_select()
     *
...
if ( ! function_exists( 'TimeZonePicker' ) ) {
    function TimeZonePicker() {
        return USARDB_WPCM_Timezone_Picker::instance();
    }
}
