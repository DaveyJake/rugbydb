 ...
 * @subpackage WPCM_Admin_Menus
 * @since 1.0.0
 */

defined( 'ABSPATH' ) || exit;

class RDB_WPCM_Admin_Menus {

    /**
     * Hook in tabs.
     */
    public function __construct() {
        add_action( 'init', array( $this, 'unset_wpcm_admin_menus' ) );
        add_action( 'before_wpcm_init', array( $this, 'reset_wpcm_admin_menus' ) );
    }

    /**
     * Reset WPCM admin menus.
     */
    public function reset_wpcm_admin_menus() {
        add_action( 'admin_menu', array( $this, 'admin_menu' ) );
        add_action( 'admin_menu', array( $this, 'rdb_dashboard_menu' ), 10 );
    ...
    /**
     * Unset WPCM admin menus.
     */
    public function unset_wpcm_admin_menus() {
        rdb_remove_class_method( 'admin_menu', 'WPCM_Admin_Menus', 'admin_menu', 10 );
        rdb_remove_class_method( 'admin_menu', 'WPCM_Admin_Menus', 'dashboard_menu', 10 );
        rdb_remove_class_method( 'admin_menu', 'WPCM_Admin_Menus', 'settings_menu', 50 );
        rdb_remove_class_method( 'admin_menu', 'WPCM_Admin_Menus', 'status_menu', 60 );
        rdb_remove_class_method( 'admin_menu', 'WPCM_Admin_Menus', 'taxonomy_menu', 40 );
        rdb_remove_class_method( 'admin_menu', 'WPCM_Admin_Menus', 'menu_highlight' );
    }
    ...
    public function admin_menu() {
        ...
        $main_page = add_menu_page( __( 'Club Manager', 'wp-club-manager' ), __( 'Club Manager', 'wp-club-manager' ), 'manage_wpclubmanager', 'wpcm-dashboard' , array( $this, 'rdb_dashboard_page' ), WPCM()->plugin_url() . '/assets/images/logo.png', '31' );
     ...
     * Dashboard menu item
     */
    public function rdb_dashboard_menu() {
        add_submenu_page( 'wpcm-dashboard', __( 'WP Club Manager Dashboard', 'wp-club-manager' ),  __( 'Dashboard', 'wp-club-manager' ) , 'manage_wpclubmanager', 'wpcm-dashboard', array( $this, 'rdb_dashboard_page' ) );
    }
     ...
     */
    public function rdb_dashboard_page() {
        RDB_WPCM_Admin_Dashboard::output();
    }
    ...
    public function settings_page() {
        include_once WPCM()->plugin_path() . '/includes/admin/class-wpcm-admin-settings.php';
...
return new RDB_WPCM_Admin_Menus();
