...
class RDB_WPCM_Meta_Box_Match_Player_Enhancements {
    /**
     * Primary constructor.
     *
     ...
     *
     * @see 'wpcm_players_shirt_number_output'
     *
    ...
    public function wpcm_player_squad_number_html( $squad_number, $player_id ) {
        $reserved = array( 'USA', 'United States', 'united-states', 'usa-rugby', 'usa-eagles', 'USA Rugby', 'USA Eagles' );
...
return new RDB_WPCM_Meta_Box_Match_Player_Enhancements();
