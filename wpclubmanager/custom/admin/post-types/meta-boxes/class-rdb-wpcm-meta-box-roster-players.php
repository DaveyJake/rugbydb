...
class RDB_WPCM_Meta_Box_Roster_Players {
    /**
     * Output the metabox
     */
    public static function output( $post ) {
            ...
            <table>
                ...
                if ( $players != null ) :
                    ...
                    <thead>
                        <tr>
                            <th></th>
                            <th><?php echo __( 'Name', 'wp-club-manager' ); ?></th>
                            <th></th>
                        </tr>
                    </thead>
                    <?php
                ...
                foreach ( $players as $player ) :
                    ...
                    <tr data-club="<?php echo esc_attr( $player->ID ); ?>">
                        ...
                        <td class="club">
                            <input type="hidden" name="wpcm_roster_players[]" value="<?php echo esc_attr( $player->ID ); ?>" />
                            <?php echo esc_html( $player->post_title ); ?>
                        </td>
                        <td class="roster-actions">
                            <a class="" href="<?php echo get_edit_post_link( $player->ID ); ?>"><?php echo __( 'Edit', 'wp-club-manager' ); ?></a>
                        </td>
        ...
        <div class="wpcm-table-stats-footer clearfix">
            <div class="add-club">
                ...
                ?>
                <input type="button" class="button-secondary wpcm-player-roster-add-row" value="<?php echo __( 'Add player', 'wp-club-manager' ); ?>">
            </div>
            <a class="wpcm-player-roster-delete-row<?php echo ( $players !== null ? '' : ' hidden-button' ); ?>"><?php echo __( 'Remove selected', 'wp-club-manager' ); ?></a>
        </div>
        <?php
    }
