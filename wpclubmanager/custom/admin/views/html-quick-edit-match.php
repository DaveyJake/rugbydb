	...
	<div id="wpclubmanager-fields" class="inline-edit-col">
		...
		<div class="match_fields">
			...
			<label class="alignleft">
				...
				<span class="input-text-wrap">
					<input type="text" name="wpcm_comp_status" id="wpcm_comp_status" placeholder="Competition Round" value="" />
				</span>
			</label>
...
<fieldset class="inline-edit-col-left world-rugby">
	<legend class="inline-edit-legend"><?php esc_html_e( 'World Rugby & ESPN', 'rugby-database' ); ?></legend>
	<div id="wpclubmanager-fields" class="inline-edit-col">
		<label class="alignleft wr-id">
			<span class="wr-id-title"><?php esc_html_e( 'Match ID', 'rugby-database' ); ?></span>
		...
		<label class="alignleft wr-id">
			<span class="usar-scrum-id-title"><?php esc_html_e( 'Scrum ID', 'rugby-database' ); ?></span>
	...
	<div id="wpclubmanager-fields" class="inline-edit-col">
		<label class="alignleft video">
			<span class="video-url"><?php esc_html_e( 'URL', 'rugby-database' ); ?></span>
			<input type="text" name="_wpcm_video" value="" />
		</label>
	</div>
</fieldset>

<fieldset class="inline-edit-col-right match-fixture">
	<legend class="inline-edit-legend"><?php esc_html_e( 'Match Fixture', 'rugby-database' ); ?></legend>
	<div id="wpclubmanager-fields" class="inline-edit-col">
