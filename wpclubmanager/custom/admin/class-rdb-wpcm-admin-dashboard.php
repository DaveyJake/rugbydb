 ...
 * @subpackage WPCM_Admin_Dashboard
 * @since 1.0.0
 */
 ...
 * @since 1.0.0
 */
class RDB_WPCM_Admin_Dashboard {
        ...
        <div class="ui grid wpcm-dashboard">
            ...
            <?php
                if ( is_club_mode() ) {
                    ...
                    $future = array( 'post_status' => 'future' );
                    ...
                    // Roster
                    $args = array( 'post_type' => 'wpcm_roster' );
                    ...
                    // League Tables
                    $args = array( 'post_type' => 'wpcm_table' );
                    ...
                    if ( $table ) {
                        ...
                        $team_label     = rdb_wpcm_get_team_name( $default_club, $team );
                    ...
                    // Output
                    include_once get_template_directory() . '/wpclubmanager/custom/admin/views/html-admin-page-dashboard.php';
                } else {
                    wpclubmanager_get_template_part( 'views/html-admin-page', 'league-dashboard' );
                }
            ?>
            </div>
        </div>
