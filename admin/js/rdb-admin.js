...
function geoIPLookup() {
  $(document).ajaxComplete(function () {
    ...
    $('#iplockout-table .sui-accordion-item').on('click', 'td', function () {
      ...
      var target = (0, _find["default"])(_context = $(this).parent().next()).call(_context, '.sui-box-body > .sui-row:nth-child(2) > .sui-col > p:last-child > a'),
          ipAddr = target.text();
      console.log(ipAddr); // @return {string} Re-linked URL to GEO IP website.
...
(function ($) {
  // eslint-line-disable
  // Included globals.
  var pageNow = window.pagenow; // Defender
